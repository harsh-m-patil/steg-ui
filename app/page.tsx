	...
	return (
		<div className="container mx-auto py-10 px-4">
			...
			<p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
				Hide secret messages within images or extract hidden messages from
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Hide your message within an image using steganography
				</CardDescription>
			</CardHeader>
			<CardContent className="space-y-6">
				...
				<Button
					...
					className="w-full"
					disabled={isEncoding || !image || !message.trim()}
				>
